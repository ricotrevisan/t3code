...
import { IconCpu } from "@tabler/icons-react-native";
...
export function ProviderIcon(props: ProviderIconProps) {
  ...
  if (props.provider === "primeAgent") {
    const fill = isDarkMode ? "#F5F5F5" : "#0B0F14";
    return (
      <Svg width={size} height={size} viewBox="0 0 178 178" fill="none">
        <Path
          fill={fill}
  ...
  return <IconCpu color={mono} size={size} strokeWidth={1.75} />;
}
